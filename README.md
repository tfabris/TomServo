...
#### Painting:
  ...
  - Clear:
    ...
    - Immediately after applying the gloss clearcoat, while it is still wet, fold a paper towel again, and press it atop the circular edges where the two halves of the domes meet, like you did before curing the domes. This will dab away the clearcoat, keeping the lip clean so that the two halves still fit together snugly.
